...
import os
import re
from visible_stamp import VisibleStampMethod #for LL watermarking method
from lsb_image import LSBImageMethod #for LL watermarking method
...
METHODS: Dict[str, WatermarkingMethod] = {
    ...
    VisibleStampMethod().name: VisibleStampMethod(), #LL calling on new watermarking method
    LSBImageMethod().name: LSBImageMethod() #LL calling on new watermarking method
}
